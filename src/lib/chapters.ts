...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    subtitle: "Projects, Code CLI, and MCP — giving Claude a brain that persists",
    emoji: "🟣",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    ...
    number: 29,
    title: "ChatGPT / OpenAI Implementation Guide",
    subtitle: "Custom GPTs, Assistants API, and automation that remembers context",
    emoji: "🟢",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    slug: "crewai-implementation",
    number: 30,
    title: "CrewAI Implementation Guide",
    subtitle: "Unified Memory, crew.yaml, and multi-agent orchestration in production",
    emoji: "🚀",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    slug: "langchain-implementation",
    number: 31,
    title: "LangChain / LangGraph Implementation Guide",
    subtitle: "Checkpointers, Store API, and durable agent state that survives restarts",
    emoji: "🔗",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    slug: "autogpt-implementation",
    number: 32,
    title: "AutoGPT Implementation Guide",
    subtitle: "Workspace persistence, memory backends, and safe autonomous loops",
    emoji: "🤖",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    slug: "n8n-implementation",
    number: 33,
    title: "n8n Implementation Guide",
    subtitle: "AI agent nodes, Postgres memory, and cron workflows that compound",
    emoji: "⚙️",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    slug: "cursor-implementation",
    number: 34,
    title: "Cursor / Windsurf / Cline Implementation Guide",
    subtitle: "Rules, Memory Bank pattern, and editor-native context that actually sticks",
    emoji: "💻",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
  {
    ...
    number: 35,
    title: "OpenClaw Implementation Guide",
    subtitle: "HEARTBEAT.md, identity files, and full memory architecture in one workspace",
    emoji: "🐾",
    requiredTier: "accelerator",
    readTime: "12 min",
  },
