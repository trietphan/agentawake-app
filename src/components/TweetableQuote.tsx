...
export default function TweetableQuote({ quote }: { quote: string }) {
  ...
  return (
    <blockquote className="relative my-8 pl-5 pr-4 py-4 border-l-4 border-[var(--accent)] bg-[var(--accent)]/[0.04] rounded-r-xl group hover:scale-[1.01] hover:shadow-[0_0_30px_rgba(217,70,239,0.08)] transition-all duration-300">
